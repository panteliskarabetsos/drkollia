...
export default function EditPatientPage() {
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 py-16 bg-[#f9f8f6] text-[#3b3a36] font-sans">
      ...
      <h1 className="text-3xl font-semibold mb-10 text-center text-[#2e2d2c]">Επεξεργασία Ασθενούς</h1>
      ...
      <div className="mt-10 flex justify-end gap-4">
        <button
          onClick={() => router.back()}
          className="px-5 py-2 text-sm bg-gray-50 text-gray-600 rounded-md hover:bg-gray-100 transition border border-gray-200"
        >Άκυρο</button>
        <button
          onClick={handleSave}
          disabled={saving}
          className="px-5 py-2 text-sm bg-[#8c7c68] text-white rounded-md hover:bg-[#6f6253] disabled:opacity-50 transition flex items-center gap-2"
        >
          {saving && <ImSpinner2 className="animate-spin text-base" />}
          Αποθήκευση
        </button>
      </div>
    </main>
