...

  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-1 text-gray-600">
        ...
        <li>
          Τα δεδομένα ασθενών υπόκεινται σε κανόνες απορρήτου· κρατάτε
          σημειώσεις με φειδώ.
        </li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-1 text-gray-600">
        ...
        <li>
          Το ιστορικό επισκέψεων καταχωρείται αυτόματα όταν ένα ραντεβού γίνει{" "}
          <em>completed</em> (μέσω trigger).
        </li>
        <li>
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-1 text-gray-600">
        ...
        <li>
          Πολιτικές slots: 30′ για «Εξέταση» στις :00/:30, «Αξιολόγηση» σε
          “καθαρά” 30′ ή επισκευαστικά 15′—χωρίς σκόρπια 15′.
        </li>
        <li>
          Κράτηση “reserved” blocks για «Αξιολόγηση» (προαιρετική ρύθμιση αν την
          ενεργοποιήσετε).
        </li>
        <li>
          Realtime ενημέρωση κατάστασης ραντεβού και άμεση ανανέωση λίστας.
        </li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-1 text-gray-600">
        <p>Για τεχνικά θέματα: support@yourclinic.gr</p>
        <p>Ώρες υποστήριξης: Δευ–Παρ 09:00–17:00.</p>
        <p>Παρακαλούμε επισυνάψτε screenshot/βήματα αναπαραγωγής σφάλματος.</p>
      </div>
    ),
  },
];
